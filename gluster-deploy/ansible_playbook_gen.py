...
from common import YamlWriter


class AnsiblePlaybookGen(Helpers, YamlWriter):
    ...
    def move_templates_to_playbooks(self):
        ...
        templates_path_bk = self.get_file_dir_path('../share/', 'templates')
